...
void ItemAddOptionBmd::TxtOut(ofstream & os)
{
	assert(os);

	os << "//ItemCat\tItemIndex\tOption_1\tValue_1\tOption_2\tValue_2\tTime" << endl;
...
void ItemAddOptionBmd::TxtIn(ifstream & is)
{
	assert(is);
